...
void debug_init(void) {
    // TODO: Fix this for whatever pins I decided to use on my board
    //
...
/*****!!!!! This function is broken, it calls strlen on str, which sometimes is not
 * a string but a pointer to a char and therefore not zero terminated
 *****!!!!!*/
/*void print_now(char str[]) {*/
